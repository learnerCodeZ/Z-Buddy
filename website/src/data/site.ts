...
export const SITE = {
  ...
  description:
    '一只挂在桌面角落的 AI 编程伙伴：实时反映 ZCode 工作状态、点一下就暂停、宠物包即装即换。免费开源，仅约 7 MB。',
  ...
  releaseTag: 'https://github.com/learnerCodeZ/Z-Buddy/releases/tag/v0.2.0',
  // Release 产物命名（上传 Release 时保持一致）
  assets: {
    setup: 'Z-Buddy_0.2.0_x64-setup.exe',
    portable: 'z-buddy-app.exe', // 免安装版：v0.2.0 起直接是 exe（旧版才是 portable.zip）
    sha256: 'SHA256SUMS.txt', // 由 CI 在打 tag 时生成并随 Release 上传
  },
};
